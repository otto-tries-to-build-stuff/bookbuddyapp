...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are BookBuddy, a knowledgeable AI assistant that helps users revise and recall knowledge from books they've read. You have access to the user's book library.
